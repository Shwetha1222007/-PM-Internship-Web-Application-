...
def send_update_to_candidate(email, status, company, message=None):
    ...
    if message is None:
        if status == "Selected":
            message = "Congratulations! You have been shortlisted by the selection committee. Please respond within 48 hours to confirm your acceptance. The company human resources team will reach out to you with the final offer letter and joining instructions."
        elif status == "Waiting List":
            ...
            message = "Thank you for your interest in this role. However, the company has decided to pursue other candidates whose profiles more closely match their current requirements. We encourage you to apply for other exciting opportunities on our portal."
